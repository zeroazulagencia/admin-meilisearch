...
const BASE = '/api/custom-module3/generador-carta-laboral';
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-700 mb-2">
              POST /api/custom-module3/generador-carta-laboral/generar
            </p>
...
{`curl -X POST https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/generar \\
...
{`{
  ...
  "pdf_url": "https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/pdf?token=abc123...",
  "pdf_token": "abc123...",
  "pdf_token_expires_at": "2025-01-20 14:30:00"
          ...
          <div>
            <p className="text-sm font-semibold text-gray-700 mb-2">
              GET /api/custom-module3/generador-carta-laboral/pdf?token=TOKEN
            </p>
            <p className="text-sm text-gray-500 mb-2">
            ...
            <pre className="bg-gray-900 text-green-400 text-xs rounded-lg px-4 py-3 overflow-x-auto font-mono whitespace-pre">
{`curl -o carta.pdf \\
  "https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/pdf?token=abc123..."`}
            </pre>
          </div>

          <div>
            <p className="text-sm font-semibold text-gray-700 mb-2">
              GET /api/custom-module3/generador-carta-laboral/historial
            </p>
            <p className="text-sm text-gray-500 mb-2">
              Lista el historial de cartas generadas con paginacion.
            </p>
            <pre className="bg-gray-900 text-green-400 text-xs rounded-lg px-4 py-3 overflow-x-auto font-mono whitespace-pre">
{`curl "https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/historial?page=1&limit=20"`}
            </pre>
          </div>

          <div>
            <p className="text-sm font-semibold text-gray-700 mb-2">
              GET/PUT /api/custom-module3/generador-carta-laboral/config
            </p>
            <p className="text-sm text-gray-500 mb-2">
            ...
            <pre className="bg-gray-900 text-green-400 text-xs rounded-lg px-4 py-3 overflow-x-auto font-mono whitespace-pre">
{`# Leer configuracion
curl "https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/config"

# Actualizar campo
curl -X PUT "https://workers.zeroazul.com/api/custom-module3/generador-carta-laboral/config" \\
  -H "Content-Type: application/json" \\
