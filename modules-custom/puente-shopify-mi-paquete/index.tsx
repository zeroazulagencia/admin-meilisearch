...
export default function PuenteShopifyMiPaqueteModule({
  moduleData,
}: {
  moduleData?: {
    id: number;
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4">
      <div className="space-y-4">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Puente Shopify MiPaquete</h2>
        ...
        {activeTab === 'inicio' && (
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl p-4 text-white">
              <h3 className="text-xl font-bold mb-1">Puente Shopify MiPaquete</h3>
