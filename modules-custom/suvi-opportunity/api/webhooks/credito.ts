...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log('[WEBHOOK-CREDITO] recibido', captured.payload_raw);
    ...
    processOpportunity(recordId).catch((e) => console.error('[WEBHOOK-CREDITO]', e));
    return NextResponse.json({ ok: true, id: recordId, tipo: 'credito' }, { status: 200 });
  } catch (e: any) {
    console.error('[WEBHOOK-CREDITO]', e);
