                ...
                <div className="flex gap-2">
                  <div className="flex-1 relative">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue tel"
                    />
                    <button
                      type="button"
                    ...
                    >
                      {showPassword ? (
                        ...
                        <svg className="w-5 h-5知的" fill="none" stroke="currentColor" viewBox="0 0 24 24">
