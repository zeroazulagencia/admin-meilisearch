...
export default function Home() {
  ...
  const portfolioCards = [
    { category: "FINANZAS", title: "Departamento de Finanzas", description: "Agentes que concilian pagos, generan reportes financieros, monitorean cuentas por cobrar y pagar, alertan sobre anomalias, gestionan facturacion automatizada y mantienen la salud financiera de la empresa en tiempo real." },
    { category: "ATENCION", title: "Departamento de Atencion al Cliente", description: "Multiples agentes que atienden consultas por WhatsApp, web y redes, escalan casos complejos, hacen seguimiento post-venta y mantienen clientes informados sin esperas ni horarios." },
    { category: "OPERACION", title: "Departamento de Operaciones", description: "Agentes que monitorean procesos, gestionan inventarios, coordinan ordenes de produccion, alertan desvios y mantienen la cadena operativa funcionando sin fricciones." },
    { category: "VENTAS", title: "Departamento de Ventas y CRM", description: "Equipo de agentes que califican leads, programan seguimientos, actualizan el CRM, generan cotizaciones y acompanan al cliente desde el primer contacto hasta el cierre." },
    { category: "INVENTARIOS", title: "Departamento de Inventarios y Logistica", description: "Agentes que monitorean stock en tiempo real, alertan sobre minimos y maximos, coordinan ordenes de compra, rastrean envios, gestionan proveedores y mantienen la cadena de suministro funcionando sin intervencion manual." },
    { category: "DATOS", title: "Departamento de Analitica de Datos", description: "Analistas IA que consolidan datos de todas las areas, generan dashboards, detectan anomalias, emiten alertas predictivas y entregan reportes accionables semanales." },
    { category: "RRHH", title: "Departamento de Recursos Humanos", description: "Agentes que filtran y preseleccionan candidatos, coordinan entrevistas, gestionan onboarding, monitorean clima laboral, administran ausentismo y mantienen los procesos de talento automatizados y en marcha." },
  ];
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
                <span className="border-b-4 border-[#5DE1E5]">Equipos Completos</span> de Agentes IA
              </h1>
              <p className="text-xl sm:text-2xl font-semibold text-gray-800">Agentes autonomos que trabajan solos, interconectados con todos tus sistemas</p>
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">Montar un sistema de agentes no es conectar un chat y ya. Disenamos equipos completos de agentes que trabajan solos: se interconectan con tus APIs, bases de datos, ERPs y CRMs. Toman decisiones, ejecutan tareas complejas y se coordinan entre si sin intervencion humana. Cada agente opera autonomamente dentro de su area, pero todos trabajan como un solo equipo 24/7.</p>
            </div>
                ...
                <div key={i} className="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-shadow">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#5DE1E5' }}>
                      ...
                      {card.category === "RRHH" && (
                        <svg className="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0z" /></svg>
                      )}
                    </div>
...
<section className="py-20 bg-gray-50 border-t border-gray-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-sm font-semibold uppercase tracking-widest mb-4" style={{ color: '#5DE1E5' }}>METAS DE NEGOCIO</p>
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Contrata por metas de negocio, no por tareas sueltas</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">No compres agentes sueltos. Contrata un departamento completo que apunte a resultados concretos: aumentar ventas, reducir costos operativos o mejorar el servicio al cliente. Nuestros agentes estan disenados para cumplir metas, no solo tareas.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
            <div className="w-12 h-12 rounded-full bg-gray-900 text-white font-bold text-2xl flex items-center justify-center mx-auto mb-4">1</div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">Aumentar Ventas</h3>
            <p className="text-sm text-gray-600">Un equipo de agentes que califica leads, atiende consultas, genera cotizaciones, programa seguimientos y cierra mas oportunidades. Tu equipo comercial se enfoca en negociar, no en prospectar.</p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
            <div className="w-12 h-12 rounded-full bg-gray-900 text-white font-bold text-2xl flex items-center justify-center mx-auto mb-4">2</div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">Reducir Costos Operativos</h3>
            <p className="text-sm text-gray-600">Departamento de operaciones con agentes que automatizan tareas repetitivas, monitorean procesos, gestionan inventarios y eliminan cuellos de botella. Operacion mas eficiente por menos costo.</p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
            <div className="w-12 h-12 rounded-full bg-gray-900 text-white font-bold text-2xl flex items-center justify-center mx-auto mb-4">3</div>
            <h3 className="text-lg font-bold text-gray-900 mb-2">Mejorar Servicio al Cliente</h3>
            <p className="text-sm text-gray-600">Multiples agentes que atienden 24/7 por WhatsApp, web y redes, escalan casos complejos y hacen seguimiento post-venta. Clientes satisfechos, retencion garantizada.</p>
          </div>
        </div>
        <div className="text-center mt-10">
          <button onClick={() => setShowContactModal(true)} className="text-gray-900 px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition-all shadow-md" style={{ backgroundColor: '#5DE1E5' }}>Empieza con tu meta</button>
        </div>
      </div>
    </section>
